...
<div
    ...
    <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
        <div
            class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded ">
            <h1 class="mb-1 font-medium">Let's get started</h1>
            <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Create an account to proceed to the demo.</p>
        ...
        <div
            class="bg-[#00000000] dark:bg-[#00000000] pl-10 relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/376] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden">
            <svg
                class="w-full text-[#FFFFFF] dark:text-[#FFFFFF] transition-all translate-y-0 opacity-100 max-w-none duration-750 starting:opacity-0 starting:translate-y-6"
                viewBox="0 0 38 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M34.7106 29.6731C33.0148 31.6676 30.5458 32.845 27.9275 32.9504C25.2037 33.1349 22.5502 32.142 20.626 30.2266C19.9582 29.6028 19.4134 28.8999 18.9653 28.1267H29.5793V6.56479H8.0614V17.8817C6.95431 17.7675 5.89115 17.4424 4.8895 16.9591C1.86698 15.3336 0.206344 12.8295 0.0218289 9.4028C-0.162686 6.8196 0.830179 4.28032 2.71047 2.51425C4.41504 0.809689 6.51499 0.00133924 9.57266 0.00133924C10.8994 -0.0338064 12.6303 0.625175 14.2558 1.69712C15.2135 2.32095 16.1713 2.98872 17.1641 3.54226C18.9741 4.53513 21.0741 4.79872 23.0598 4.24518C24.1669 3.94644 25.2301 3.54226 26.302 3.17323C27.5585 2.65484 28.9555 2.50547 30.2822 2.68998C33.5596 3.24353 35.844 6.3012 35.3696 9.62246C35.2554 10.3605 35.1499 11.0634 35.0005 11.7927C34.4821 13.8575 34.7018 16.0278 35.6683 17.952C36.257 19.0942 36.6963 20.3507 36.9599 21.6335C37.4432 24.656 36.7403 27.3447 34.7106 29.6643V29.6731Z"
                    fill="currentColor"></path>
                <path
                    d="M18.9736 28.1258H8.06089V17.8808C8.50021 17.9511 8.98347 17.995 9.45793 18.0302C10.565 18.0653 11.6721 18.2147 12.7353 18.4343C14.6859 18.8385 16.2762 20.2443 16.9352 22.1158C17.3745 23.2932 17.6732 24.5145 18.0423 25.6919C18.2268 26.5354 18.5607 27.3526 18.9648 28.1258H18.9736Z"
                    fill="currentColor"></path>
            </svg>
        </div>
    </main>
